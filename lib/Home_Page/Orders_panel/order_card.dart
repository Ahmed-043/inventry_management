            ...
            child: Container(
              ...
              child: Stack(
                children: [
                  Container(
                    ...
                    child: Column(
                      children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: UiHelper.myButton(
                                      callback: () async {
                                        ...
                                        oldOrder.editable = false;
                                        oldOrder.totalAmount = oldOrder.totalAmount
                                            .abs();
                                        viewOrder(oldOrder);
                                      },
                                      title: 'View Details',
                        ...
                        Divider(height: 0.5, color: MyColors.lightGrey),
                        Expanded(
                          flex: 2,
                          child: Row(
                            children: [
                  ...
                  UiHelper.percentFillBar(
                      percent: order.orderStatus == 'Completed' ? 0 : percent,
