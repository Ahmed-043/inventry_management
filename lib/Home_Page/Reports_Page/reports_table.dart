          ...
          children: [
            ...days.map(
              (d) => ReportsCellBuilder.buildCell(
                DateFormat(ReportsConstants.csvDateFormat).format(d),
                ReportsConstants.dataColWidth,
                isHeader: true,
              ),
            ),
...
class ReportsCellBuilder {
  ...
  static Widget buildDataCell(
    ...
    final textColor = ReportsUtils.getTextColor(info.stockAtEnd, limit);
  ...
  static Widget buildCurrentStockCell(
    ...
    final textColor = ReportsUtils.getTextColor(stock, limit);
